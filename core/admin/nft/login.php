...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo get_admin_template_folder();?>/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo ADMINURL; ?>/"><b>Admin</b> Panel</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Login to panel</p>
    ...
    <form action="<?php echo ADMINURL; ?>/login/" method="post">
      <div class="form-group has-feedback">
        <input type="login" name = "name" class="form-control" placeholder="Login">
